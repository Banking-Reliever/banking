...
2. **Envelopes section**:
   - Balances of the main envelopes (the most frequent categories, determined by the tier definition in CAP.REF.001.TIE)
...
## Open Questions
- [ ] Which envelopes are considered "main" on mobile? Are they determined by the current tier (CAP.REF.001.TIE) or by the beneficiary's usage frequency?
