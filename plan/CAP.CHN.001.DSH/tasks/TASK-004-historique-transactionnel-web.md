...
Extend the TASK-002 stub mechanism to publish the transactional events on the CAP.CHN.001.DSH subscription point:
...
- [ ] Is the decline reason a fixed enumeration (dictated by CAP.REF.001.TIE tiers) or free text produced by BSP.004.AUT?
