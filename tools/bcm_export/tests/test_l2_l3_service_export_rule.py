        ...
        model = BCMModel(
            ...
            capabilities_l2=[
                CapabilityL2(
                    ...
                    description="Parent L2 capability",
                    owner="Claims Management",
                ...
                CapabilityL2(
                    ...
                    name="Coverage instruction",
                    description="Child L3 capability",
                    owner="Claims Management",
                    parent_l1_id="CAP.COEUR.005",
                ...
                CapabilityL2(
                    ...
                    name="Declaration",
                    description="L2 capability without children",
                    owner="Claims Management",
                    parent_l1_id="CAP.COEUR.005",
                    zoning="SERVICES_COEUR",
                    level="L2",
