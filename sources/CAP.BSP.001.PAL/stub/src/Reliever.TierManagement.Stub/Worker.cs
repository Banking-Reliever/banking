...
/// <summary>
/// Background worker that publishes simulated RVT.BSP.001.FRANCHISSEMENT_ENREGISTRE
/// messages on the RabbitMQ topic exchange owned by CAP.BSP.001.PAL.
///
...
public sealed class Worker : BackgroundService
{
    ...
    protected override async Task ExecuteAsync(CancellationToken stoppingToken)
    {
        ...
        // ADR-TECH-STRAT-001 Rule 1, 5 — declare the topic exchange owned by CAP.BSP.001.PAL.
        ...
        while (!stoppingToken.IsCancellationRequested)
        {
            try
            {
                ...
                var props = new BasicProperties
                {
                    ...
                    Type = "RVT.BSP.001.FRANCHISSEMENT_ENREGISTRE",
                ...
                _logger.LogInformation(
                    "Published RVT.BSP.001.FRANCHISSEMENT_ENREGISTRE for dossier={CaseId}",
                    caseId);
            }
