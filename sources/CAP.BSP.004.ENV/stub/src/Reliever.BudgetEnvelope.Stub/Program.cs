...
using Reliever.BudgetEnvelope.Stub;

// CAP.BSP.004.ENV — development stub host.
//
// This .NET 10 worker publishes simulated RVT.BSP.004.CONSUMPTION_RECORDED
// payloads on a RabbitMQ topic exchange owned by CAP.BSP.004.ENV, honoring
// the runtime JSON Schema shipped next to the assembly under schemas/.
// The whole stub is governed by:
//
//   - ADR-BCM-FUNC-0008 (BSP.004 L2 breakdown — ENV / ALT / AUT)
