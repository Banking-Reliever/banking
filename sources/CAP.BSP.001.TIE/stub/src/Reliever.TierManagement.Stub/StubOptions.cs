...
/// <summary>
/// Strongly-typed configuration for the CAP.BSP.001.TIE development stub.
...
{
    /// <summary>
    /// Topic exchange owned by CAP.BSP.001.TIE (ADR-TECH-STRAT-001 Rule 1, 5).
    ...
    /// </summary>
    public string RoutingKey { get; set; } = "EVT.BSP.001.TIER_UPGRADED.RVT.BSP.001.TIER_UPGRADE_RECORDED";
}
...
public sealed class SchemaOptions
{
    ...
    /// </summary>
    public string RuntimeSchemaPath { get; set; } = "schemas/RVT.BSP.001.TIER_UPGRADE_RECORDED.schema.json";
}
