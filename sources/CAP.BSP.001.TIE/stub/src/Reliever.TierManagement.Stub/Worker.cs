...
/// <summary>
/// Background worker that publishes simulated RVT.BSP.001.TIER_UPGRADE_RECORDED
/// messages on the RabbitMQ topic exchange owned by CAP.BSP.001.TIE.
///
...
public sealed class Worker : BackgroundService
{
    ...
    protected override async Task ExecuteAsync(CancellationToken stoppingToken)
    {
        ...
        // ADR-TECH-STRAT-001 Rule 1, 5 — declare the topic exchange owned by CAP.BSP.001.TIE.
        ...
        while (!stoppingToken.IsCancellationRequested)
        {
            try
            {
                ...
                var props = new BasicProperties
                {
                    ...
                    Type = "RVT.BSP.001.TIER_UPGRADE_RECORDED",
                    Headers = new Dictionary<string, object?>
                    {
                        ["x-bcm-business-event"] = "EVT.BSP.001.TIER_UPGRADED",
                        ["x-bcm-resource-event"] = "RVT.BSP.001.TIER_UPGRADE_RECORDED",
                        ["x-bcm-emitting-capability"] = "CAP.BSP.001.TIE",
                        ["x-bcm-version"] = "1.0.0"
                    }
                };
                ...
                _logger.LogInformation(
                    "Published RVT.BSP.001.TIER_UPGRADE_RECORDED for case={CaseId}",
                    caseId);
            }
