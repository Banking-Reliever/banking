...
- `RES.BSP.001.CURRENT_SCORE` — carried by `RVT.BSP.001.SCORE_COURANT_RECALCULE` (resource read model maintained by consumers — not transported as snapshot)
